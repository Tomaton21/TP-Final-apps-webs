...
<head>
    ...
    function modificar($disabled){
        if ($disabled == 1) {
            ...
            ?>
            <div class="mb-3">
                <label for="codp" class="form-label">Codigo del cliente</label>
            ...
            <div class="mb-3">
                <label for="cuit" class="form-label">Ingrese el CUIT/DNI</label>
            ...
            <div class="mb-3">
                <label for="desc" class="form-label">Ingrese un descuento al cliente(opcional)</label>
                <input type="text" class="form-control" id="desc" name="desc" value= <?php echo $desc ?>>
            </div>
            <button type="submit" class="btn btn-success" name='boton' value=1>Modificar cliente</button>
        ...
        <?php   
            ...
            <button type="submit" class="btn btn-success" name='boton' value=2>Crear Cliente</button>
            <button type="submit" class="btn btn-danger" name='boton' value=0>Cancelar</button>
            <?php   
        }
...
<div class="row">
        ...
        <form action="crearcliente-destino.php" method="POST">
        <?php
